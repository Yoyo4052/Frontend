...
function Questionary({ cuestionario , setShowEdit, descCuestionario, handleDescChange, getQuestionaries}) {
  ...
  const setDescripcion = async () => {
    ...
    const response = await fetch(`https://99c1-2806-2f0-21c0-fd27-dd43-6331-feef-454d.ngrok-free.app/CambiarCuestionario/${cuestionario.id}`, requestOptions);
  ...
  const registerQuestion = async () => {
    ...
    const response = await fetch("https://99c1-2806-2f0-21c0-fd27-dd43-6331-feef-454d.ngrok-free.app/registrarPregunta/", requestOptions);
    const data = await response.json();
  ...
  const deleteQuestion = async (pregunta_id) => {
    ...
    const response = await fetch(`https://99c1-2806-2f0-21c0-fd27-dd43-6331-feef-454d.ngrok-free.app/EliminarPregunta/${pregunta_id}/`, requestOptions);
    const data = await response.json();
