...
const Questions = () => {
  ...
  const fetchQuestions = async () => {
    try {
      const response = await fetch(`https://cbc4-2806-2f0-21c0-fd27-dd43-6331-feef-454d.ngrok-free.app/verCuestionario/${cuestionarioId}`);
  ...
  async function run() {
    ...
    * ...
    ...
    const resultResponse = await fetch(`https://cbc4-2806-2f0-21c0-fd27-dd43-6331-feef-454d.ngrok-free.app/registrarResultadoFODA/`, requestOptions);
