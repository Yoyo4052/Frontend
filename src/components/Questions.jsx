...
const Questions = () => {
  ...
  const fetchQuestions = async () => {
    try {
      const response = await fetch(`http://127.0.0.1:8000/verCuestionario/${cuestionarioId}`);
  ...
  async function run() {
    ...
    * ...
    ...
    const resultResponse = await fetch(`http://127.0.0.1:8000/registrarResultadoFODA/`, requestOptions);
