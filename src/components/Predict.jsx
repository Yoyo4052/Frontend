...
const Predict = () => {
  ...
  const getQuestions = async () => {
    const response = await fetch(`https://b14d-2806-2f0-21c0-fd27-dd43-6331-feef-454d.ngrok-free.app/verCuestionario/6`);
  ...
  const registerAnswers = async () => {
    ...
    for (let i = 0; i < questions.length; i++) {
      ...
      const response = await fetch(`https://b14d-2806-2f0-21c0-fd27-dd43-6331-feef-454d.ngrok-free.app/registrarRespuestas/`, requestOptions);
      if (!response.ok) {
        console.error("Error:", await response.json());
      }
    }

    const resultResponse = await fetch(`https://b14d-2806-2f0-21c0-fd27-dd43-6331-feef-454d.ngrok-free.app/gemini/${id}/`);
