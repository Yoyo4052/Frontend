...
const Results = () => {
  ...
  const getResults = async () => {
    ...
    const response = await fetch(`http://127.0.0.1:8000/verResultados/${id}/`, requestOptions);
  ...
  const deleteResult = async (resultado_id) => {
    ...
    const response = await fetch(`http://127.0.0.1:8000/EliminarResultado/${resultado_id}/`, requestOptions);
    const data = await response.json();
