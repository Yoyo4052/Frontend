...
const AdminTest = () => {
  ...
  const getQuestions = async () => {
    ...
    const response = await fetch(`https://3708-2806-2f0-21c0-fd27-dd43-6331-feef-454d.ngrok-free.app/verCuestionario/${cuestionarioId}`, requestOptions);
...
Gracias.`;
    ...
    const resultResponse = await fetch(`https://3708-2806-2f0-21c0-fd27-dd43-6331-feef-454d.ngrok-free.app/registrarPrueba/`, requestOptions);
